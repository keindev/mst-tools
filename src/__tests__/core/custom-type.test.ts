...
import { applyPatch, applySnapshot, onSnapshot, recordPatches, SnapshotOut, unprotect } from '../../mst/index';
...

{
  ...
  it('should allow for custom primitive types', () => {
  ...
  // test reassignment / reconciliation / conversion works
  it('reassignments will work', () => {
    configure({
  ...
  it('passes environment to fromSnapshot', () => {
...

{
  ...
  it('should allow for complex custom primitive types', () => {
    const w1 = Wallet.create({
      balance: new Decimal('2.5'),
    });
  ...
  // test reassignment / reconciliation / conversion works
  it('complex reassignments will work', () => {
    configure({
      enforceActions: 'never',
    });
  ...
  it('can apply snapshot and patch', () => {
