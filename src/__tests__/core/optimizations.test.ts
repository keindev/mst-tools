...
import { applySnapshot, getSnapshot, unprotect } from '../../mst/index';

it('should avoid processing patch if is exactly the current one in applySnapshot', () => {
...
it('should avoid processing patch if is exactly the current one in reconcile', () => {
  configure({
