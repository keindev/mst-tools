...
describe('null as default', () => {
  describe('basic tests', () => {
    ...
    it('with optional values, then assigned values', () => {
      const m = M.create({
        x: null,
        y: null,
      });
    ...
    it('with given values, then assigned optional values', () => {
      const m = M.create({
        x: 10,
        y: 20,
      });
  ...
  it('when the underlying type accepts undefined it should be ok', () => {
    const M = types.model('', {
  ...
  it('when the underlying type does not accept undefined, then undefined should throw', () => {
    const M = types.model('', {
...
it('cached snapshots should be ok when using default values', () => {
